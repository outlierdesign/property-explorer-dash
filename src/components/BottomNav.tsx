import { Home, FileText, Mountain, Heart } from "lucide-react";
    ...
    <>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-card border-t border-border shadow-elegant">
        <div className="grid grid-cols-4 h-16">
          ...
          <button
            onClick={() => {
              // Trigger the favorites drawer by simulating a click on the floating button
              const favButton = document.querySelector('[data-favorites-button]') as HTMLButtonElement;
          ...
          >
            <div className="relative">
              <Heart className={cn("h-5 w-5", count > 0 && "fill-primary text-primary")} />
              {count > 0 && (
                <Badge 
                  variant="destructive" 
